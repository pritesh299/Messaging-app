...
const Card: React.FC<CardProps> = ({
  ...
  const [user, setUser] = useState<{
    ...
    username: String;
    lastMessgae: string;
    lastMessgaeSeen: Boolean;
    lastMessgaeSenderId: Number;
    TimeStamp: string;
    Avatar: string;
  }>();
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      const lastMessgae = await getLastMessage(conversationId);
      ...
      if (lastMessgae.senderId !== getGlobal("id") && lastMessgae.isDilivered) {
      ...
      userData &&
        setUser({
          ...
          lastMessgaeSeen: lastMessgae ? lastMessgae.isDilivered : false,
          ...
          <div className="text-left w-[80%]">
            ...
            <div className="flex gap-2 items-center">
              ...
              <p className="text-slate-400 text-sm">
                {reduceMessage(user?.lastMessgae)}
              </p>
            </div>
          </div>
