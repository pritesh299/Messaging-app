...
export default function generateServerMessage(user) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (exist) {
                ...
                const response = yield DEVELOPER.save();
            }
            let response1 = yield DEVELOPER.updateOne({ contactList: [...DEVELOPER.contactList, user] });
            let response2 = yield user.updateOne({ contactList: [...user.contactList, DEVELOPER] });
            ...
            let reposnse = yield newMessage.save();
        }
        catch (error) {
            console.error(error);
        }
